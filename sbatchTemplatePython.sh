...
pip3 install scipy
pip3 install pillow
pip3 install torchvision tqdm opencv-python-headless matplotlib albumentations gradio


# Submit your job to the cluster
srun --gres=gpu:1 python3 /common/home/projectgrps/CS701/CS701G8/gitcodes/SAM-Med2D/test.py